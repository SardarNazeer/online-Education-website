...
<section class="playlists">
    ...
    ?>
            <div class="box">
                <div class="flex">
                    <div><i class="bx bx-dots-vertical-rounded" style="<?php if($fetch_playlist['status'] == ['active']){echo 'color: limegreen';}else{echo "red";} ?>"></i> <span style="<?php if($fetch_playlist['status'] == 'active'){echo "limegreen";}else{echo "red";} ?>"><?= $fetch_playlist['status'] ?></span></div>
