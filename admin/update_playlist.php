...
<section class="playlist-form">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <select name="status" class="box">
            <option value="<?= $fetch_playlist['status']; ?>" selected disabled >value="<?= $fetch_playlist['status']; ?>"</option>
            <option value="active">active</option>
            <option value="deactive">deactive</option>
        </select>
        <p>playlist title <span>*</span></p>
        <input type="text" name="title" value="<?= $fetch_playlist['title']; ?>" maxlength="100" required placeholder="Enter Playlist Title" class="box">
        <p>playlist title <span>*</span></p>
        <textarea name="description" required placeholder="Write description" class="box"cols="30" rows="10">value="<?= $fetch_playlist['description']; ?>"</textarea>
